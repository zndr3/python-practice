...
class IndividualClient(Client):
    ...
    # Override show_details() using super() to include subclass-specific info.
    def show_details(self):
        return super().show_details() + (self.get_personal_lawyer(),)
...
class Lawfully:
    ...
    def get_all_clients(self):
        # Now every client has its complete detail thanks to polymorphism.
